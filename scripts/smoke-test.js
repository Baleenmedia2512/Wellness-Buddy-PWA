...
const ENDPOINTS = [
  ...
  ['GET',  '/api/food-corrections/global'],
  ['GET',  '/api/token/latest-costs'],
  ['GET',  '/api/misc/club-attendance'],
  ['GET',  '/api/nutrition-centers'],
  ['GET',  '/api/screen/history'],
  ['GET',  '/api/misc/time-windows'],
  ...
  ['PUT',  '/api/food-corrections/nutrition', {}],
  ...
  ['GET',  '/api/user/status'],
  ['GET',  '/api/food-corrections/stats'],
