...
registerFlag({
  ...
  removeBy:       '2027-02-16',
  description:    'ADR-0008 — Manual Log Good Habit tile: Before vs After or Image + Notes. New good_habits_table; Diary kind good-habit; wellness-score good_habit_post. Does not change food logging or capture state machine.',
  defaultEnabled: true,
});
