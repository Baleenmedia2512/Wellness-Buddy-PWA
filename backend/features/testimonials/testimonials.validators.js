...
// 10 MB each keeps Share Video downloads small enough for mobile 4G.
export const MAX_HEALTH_VIDEO_BYTES   = 10 * 1024 * 1024;
export const MAX_BUSINESS_VIDEO_BYTES = 10 * 1024 * 1024;
