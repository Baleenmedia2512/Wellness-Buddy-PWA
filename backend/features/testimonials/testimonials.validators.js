 ...
 *   - beforeImageBase64 + beforeWeightKg + goalType + durationText → status: 'incomplete'
 *   - Adding afterImageBase64 + afterWeightKg (on submit or edit)  → status: 'pending' + email coach
 */
import { ValidationError } from '../../shared/lib/ValidationError.js';

const GOAL_TYPES = ['loss', 'gain'];
const MAX_DURATION_LEN = 100;
const MAX_BASE64_SIZE = 1.5 * 1024 * 1024; // 1.5 MB base64 ≈ 1 MB binary
 ...
 * After photo + weight are optional — omitting them creates an 'incomplete' record.
 */
