  ...
  return (
    <div className="space-y-3 sm:space-y-4">
      <div className="flex items-center gap-2">
        <Pill size={18} className="text-red-600 sm:w-5 sm:h-5" />
        <h3 className="text-base sm:text-lg font-semibold text-gray-800">Current Medications</h3>
      </div>
      ...
      <div className="space-y-2">
        ...
        <textarea
          ...
          rows={5}
          className="w-full px-2.5 sm:px-3 py-2 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent resize-none"
        />
