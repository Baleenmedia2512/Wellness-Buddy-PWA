...
describe('getMarathonCalendarState — marathon 1 (starts on the 1st)', () => {
  it('maps Day 0 through Day 10 from the 1st', () => {
    expectState('2026-08-01', { inMarathon: true, marathonNumber: 1, marathonDay: 0, isDetoxDay: false, showDetoxReminder: false });
  ...
  it('is outside the marathon on the days between marathon 1 and 2', () => {
    expectState('2026-08-12', { inMarathon: false, marathonDay: null, showDetoxReminder: false });
    expectState('2026-08-13', { inMarathon: false });
    expectState('2026-08-14', { inMarathon: false });
  });
});

describe('getMarathonCalendarState — marathon 2 (starts on the 15th)', () => {
  it('maps Day 0 through Day 10 from the 15th', () => {
    expectState('2026-08-15', { inMarathon: true, marathonNumber: 2, marathonDay: 0, showDetoxReminder: false });
  ...
  it('is outside the marathon after Day 10 through month end', () => {
    expectState('2026-08-26', { inMarathon: false, showDetoxReminder: false });
    expectState('2026-08-31', { inMarathon: false, showDetoxReminder: false });
  });
});
...
describe('getMarathonCalendarState — repeats every month without hardcoded dates', () => {
  ...
  it('does not treat month-end leftover days as a marathon', () => {
    expectState('2026-01-31', { inMarathon: false });
    expectState('2026-04-30', { inMarathon: false });
    expectState('2028-02-29', { inMarathon: false });
  });

  it('returns empty state for invalid input', () => {
    expectState(null, { inMarathon: false, showDetoxReminder: false });
...
describe('getDetoxReminder', () => {
  ...
  it('returns null on Detox Days, start/end days, and days outside a marathon', () => {
    ...
    assert.equal(getDetoxReminder('2026-08-31'), null);
  });
