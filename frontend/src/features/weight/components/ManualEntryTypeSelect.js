/**
 * ManualEntryTypeSelect.js — presentational.
 * The "AI Unavailable → Log Weight" intro screen of the manual entry modal.
 */
import React from 'react';
import { X } from 'lucide-react';

export default function ManualEntryTypeSelect({ onPick, onCancel }) {
  return (
    <>
