      ...
      <div className="py-0 px-0">
        <div className="relative h-[56px] sm:h-[60px] overflow-hidden">
          <div className="absolute inset-y-0 left-0 z-10 pointer-events-none flex items-center">
            <div
              className="flex w-[56px] sm:w-[60px] items-center justify-center rounded-r-md bg-white px-0.5 py-0.5 text-center text-[8px] sm:text-[9px] font-semibold leading-[1.15] text-green-700 shadow-sm"
