...
const LoginOtpEntry = ({
  ...
  const onCellChange = (e, index) => {
    ...
    // eslint-disable-next-line react/prop-types // JS project without PropTypes enforcement; types enforced at API boundary // JS project without PropTypes enforcement; types enforced at API boundary
