...
export const APP_VERSION = {
  ...
  PLATFORMS: {
    ...
    IOS: { buildNumber: 73, versionName: '3.5.1' },
  },
};
 ...
 * 📋 CHANGE LOG
 * 
 * Version 3.5.1 (Code 72 / iOS build 73) - 2026-09-22 [ANDROID + iOS]
 *   ✨ Transformation photos: profile GET prefers R2 URLs (backend dual-writes keys; base64 kept for ≤3.5.0)
 *
 ...
 *
 * Version 3.4.5 (Code 64 / iOS build 65) - 2026-08-14 [ANDROID + iOS RELEASE]
 *   🐛 Patch release — bug fixes and stability improvements
 *
 ...
 *   🐛 Patch release — bug fixes and stability improvements
 *
 * Version 3.4.2 (Code 61 / iOS build 62) - 2026-08-07 [ANDROID + iOS RELEASE]
 *   🐛 Patch release — bug fixes and stability improvements
 *
 ...
 *
 * Version 3.2.4 (Code 44) - 2026-07-03 [ANDROID + iOS RELEASE]
 *   🚀 Major change for app
 *
