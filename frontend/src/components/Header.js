...
import { LogOut, User, LayoutDashboard, Shield, FileBarChart, Footprints, GraduationCap, TrendingUp, Map, Building2, Smartphone } from 'lucide-react';
                  ...
                  {onShowScreenTime && (
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs text-gray-500">Track your daily device usage</p>
                      </div>
                    </TouchFeedbackButton>
                  )}
