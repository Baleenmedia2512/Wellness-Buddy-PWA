              ...
              <>
                ...
                <div className="fixed top-[68px] left-1/2 -translate-x-1/2 w-[min(300px,calc(100vw-24px))] bg-white rounded-2xl shadow-2xl ring-1 ring-black/10 z-50 flex flex-col">
                  ...
                  <div className="relative px-4 pt-3 pb-3 border-b border-gray-100 text-center">
                    ...
                    {/* Email */}
                    <p className="text-[11px] text-gray-500 mb-1.5 truncate px-6">{userEmail}</p>
                    ...
                    <div className="flex justify-center mb-1.5">
                      {savedProfileImage || user?.photoURL ? (
                        ...
                        <div className={`h-12 w-12 rounded-full ${getAvatarColor()} flex items-center justify-center text-white text-xl font-bold shadow-sm`}>
                          {getInitial()}
                        </div>
                      )}
                    </div>
                  ...
                  <div className="p-2">
                    <div className="grid grid-cols-3 gap-0.5">
                      ...
                      {/* Dashboard */}
                      <TouchFeedbackButton
                        onClick={() => { onShowBackgroundHistory(); closeMenu(); }}
                      ...
                      >
                        ...
                        <span className="text-[10px] font-medium text-gray-700 text-center leading-tight">Dashboard</span>
                      </TouchFeedbackButton>
                      ...
                      {onShowAdminDashboard && (
                        <TouchFeedbackButton
                          onClick={() => { onShowAdminDashboard(); closeMenu(); }}
                          className="flex flex-col items-center py-2 px-1 rounded-xl hover:bg-gray-100 transition-colors gap-1"
                        ...
                        >
                          ...
                          <span className="text-[10px] font-medium text-gray-700 text-center leading-tight">AI Monitor</span>
                        </TouchFeedbackButton>
                      )}
                      ...
                      {onShowDisciplineReport && (
                        <TouchFeedbackButton
                          onClick={() => { onShowDisciplineReport(); closeMenu(); }}
                          className="flex flex-col items-center py-2 px-1 rounded-xl hover:bg-gray-100 transition-colors gap-1"
                        ...
                        >
                          ...
                          <span className="text-[10px] font-medium text-gray-700 text-center leading-tight">Discipline</span>
                        </TouchFeedbackButton>
                      )}
                      ...
                      {onShowWellnessEnrollment && (
                        <TouchFeedbackButton
                          onClick={() => { onShowWellnessEnrollment(); closeMenu(); }}
                          className="flex flex-col items-center py-2 px-1 rounded-xl hover:bg-gray-100 transition-colors gap-1"
                        ...
                        >
                          ...
                          <span className="text-[10px] font-medium text-gray-700 text-center leading-tight">University</span>
                        </TouchFeedbackButton>
                      )}
                      ...
                      {onShowWellnessReport && (
                        <TouchFeedbackButton
                          onClick={() => { onShowWellnessReport(); closeMenu(); }}
                          className="flex flex-col items-center py-2 px-1 rounded-xl hover:bg-gray-100 transition-colors gap-1"
                        ...
                        >
                          ...
                          <span className="text-[10px] font-medium text-gray-700 text-center leading-tight">Enrollments</span>
                        </TouchFeedbackButton>
                      )}
                      ...
                      {onShowAttendanceReport && (
                        <TouchFeedbackButton
                          onClick={() => { onShowAttendanceReport(); closeMenu(); }}
                          className="flex flex-col items-center py-2 px-1 rounded-xl hover:bg-gray-100 transition-colors gap-1"
                        ...
                        >
                          ...
                          <span className="text-[10px] font-medium text-gray-700 text-center leading-tight">My Attendance</span>
                        </TouchFeedbackButton>
                      )}
                      ...
                      {onShowClubAttendanceReport && (
                        <TouchFeedbackButton
                          onClick={() => { onShowClubAttendanceReport(); closeMenu(); }}
                          className="flex flex-col items-center py-2 px-1 rounded-xl hover:bg-gray-100 transition-colors gap-1"
                      ...
                      {onShowNutritionCentersMap && (
                        <TouchFeedbackButton
                          onClick={() => { onShowNutritionCentersMap(); closeMenu(); }}
                          className="flex flex-col items-center py-2 px-1 rounded-xl hover:bg-gray-100 transition-colors gap-1"
                      ...
                      {onShowRegisterCenter && (
                        <TouchFeedbackButton
                          onClick={() => { onShowRegisterCenter(); closeMenu(); }}
                          className="flex flex-col items-center py-2 px-1 rounded-xl hover:bg-gray-100 transition-colors gap-1"
                        ...
                        >
                          ...
                          <span className="text-[10px] font-medium text-gray-700 text-center leading-tight">Register</span>
                        </TouchFeedbackButton>
                      )}
