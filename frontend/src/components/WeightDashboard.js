        ...
        <div className="px-4 md:px-6">
          ...
          {latestWeight && currentMonthStats && (
            <div className="mb-6">
              ...
              <div className="w-full max-w-md mx-auto bg-green-200 backdrop-blur-xl rounded-2xl border border-gray-100 shadow-md p-6 text-black">
                {/* Month and Entries Info */}
                ...
                <div className="grid grid-cols-3 gap-3 mt-4">
                  ...
                  <div className="bg-white/50 backdrop-blur-sm rounded-xl p-3 text-center">
                    ...
                    <p className="text-xl font-bold text-gray-800">{currentMonthStats.minWeight}</p>
                  ...
                  <div className="bg-white/50 backdrop-blur-sm rounded-xl p-3 text-center">
                    ...
                    <p className="text-xl font-bold text-gray-800">{currentMonthStats.maxWeight}</p>
                    <p className="text-xs text-gray-600">kg</p>
                  ...
                  <div className="bg-white/50 backdrop-blur-sm rounded-xl p-3 text-center">
                    ...
                    <p className="text-xl font-bold text-gray-800">{currentMonthStats.avgWeight}</p>
                    <p className="text-xs text-gray-600">kg</p>
